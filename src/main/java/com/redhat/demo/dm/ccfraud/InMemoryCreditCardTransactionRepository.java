 ...
 */
@Service("inMemoryCreditCardTransactionRepository")
public class InMemoryCreditCardTransactionRepository implements CreditCardTransactionRepository {
	...
	public InMemoryCreditCardTransactionRepository() {
		...
		InputStream ccTransactionsInputStream = CreditCardTransactionHelper.class.getClassLoader().getResourceAsStream(TRANSACTIONS_CSV_FILE);
